...
CREATE USER "aes-manager" SUPERUSER;

-- Set user password
ALTER USER "aes-manager" PASSWORD 'test';

-- Create database with the user as owner
CREATE DATABASE aes WITH OWNER "aes-manager";

-- Grant all privileges on database to the user
GRANT ALL PRIVILEGES ON DATABASE aes TO "aes-manager";
...
(
    1, '2023-10-25 14:30:00', 2, 1, '2023-10-01', '2023-10-31',
    ...
    TRUE, 2, '2023-10-26 09:15:00'
),

-- Расчет для Петровой М.С. (Бухгалтерия) за октябрь 2023
(
    2, '2023-10-25 14:35:00', 2, 2, '2023-10-01', '2023-10-31',
    ...
    TRUE, 2, '2023-10-26 09:20:00'
),

-- Расчет для Сидорова А.П. (IT отдел) за октябрь 2023 (не утвержден)
(
    3, '2023-10-25 14:40:00', 2, 3, '2023-10-01', '2023-10-31',
...
(
    4, '2023-10-25 14:45:00', 2, 4, '2023-10-01', '2023-10-31',
    ...
    TRUE, 2, '2023-10-26 09:25:00'
),

-- Расчет для Иванова И.И. (IT отдел) за ноябрь 2023
(
    5, '2023-11-25 14:30:00', 2, 1, '2023-11-01', '2023-11-30',
    ...
    TRUE, 2, '2023-11-26 09:15:00'
),

-- Расчет для Петровой М.С. (Бухгалтерия) за ноябрь 2023 (отклонен)
(
    6, '2023-11-25 14:35:00', 2, 2, '2023-11-01', '2023-11-30',
